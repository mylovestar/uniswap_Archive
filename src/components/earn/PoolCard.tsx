    ...
    show ?
      <Wrapper showBackground={isStaking} bgColor={backgroundColor}>
        ...
        <TopSection style={{ alignItems: 'start' }}>
          ...
          <StyledInternalLink to={`/TSU/${currencyId(currency0)}/${currencyId(currency1)}/${stakingInfo.stakingRewardAddress}`} style={{ width: '100%' }}>
            ...
            <StatContainer style={{ width: '60%', position: 'absolute', left: '210px', top: '100px' }}>
              ...
              <RowBetween>
                ...
                <TYPE.white>{`${stakingInfo.totalRewardRate
                  ?.multiply(`${60 * 60 * 24}`)
                  ?.toFixed(0, { groupSeparator: ',' })} TSU / day`}</TYPE.white>
              </RowBetween>
              <RowBetween>
          ...
          <>
            ...
            <BottomSection showBackground={true}>
              ...
              <TYPE.black style={{ textAlign: 'right' }} color={'white'} fontWeight={500}>
                ...
                {`${stakingInfo.rewardRate
                  ?.multiply(`${60 * 60 * 24}`)
                  ?.toSignificant(4, { groupSeparator: ',' })} TSU / day`}
              </TYPE.black>
            </BottomSection>
          </>
        )}
