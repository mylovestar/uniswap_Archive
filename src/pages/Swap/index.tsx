...
export default function Swap() {
          ...
          action:
            recipient === null
              ...
              : (recipientAddress ?? recipient) === account
                ...
                : 'Swap w/ Send',
          label: [
            trade?.inputAmount?.currency?.symbol === 'ETH' ? 'ETH' : trade?.inputAmount?.currency?.symbol,
            trade?.outputAmount?.currency?.symbol === 'ETH' ? 'ETH' : trade?.outputAmount?.currency?.symbol,
  ...
  return (
    <>
      ...
      {/* <img src="/images/tsuyuai.png" width="150px"></img> */}
      <AppBody>
        <SwapHeader />
          ...
          <BottomGrouping>
            {swapIsUnsupported ? (
              ...
              <GreyCard style={{ textAlign: 'center' }}>
                <TYPE.main mt="10px" fontSize="20px">Insufficient liquidity for this trade.</TYPE.main>
      ...
      <Footer>
        ...
        <Contacts>
          ...
          <Contact><a href="" style={{ textDecoration: "none", color: "#CCCCFF", fontSize: "20px" }}>Roadmap</a></Contact>
          <Contact><a href="" style={{ textDecoration: "none", color: "#CCCCFF", fontSize: "20px" }}>Partners</a></Contact>
        </Contacts>
        <Socials>
          <Social><img src="/images/twitter.svg" alt=""  /></Social>
          <Social><img src="/images/telegram.svg" alt="" /></Social>
          <Social style={{paddingTop: "13px"}}><img src="/images/git.svg" alt="" /></Social>
        </Socials>
      </Footer>
    </>
  )
