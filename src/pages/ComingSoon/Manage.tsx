...
export default function Manage({
  ...
  console.log('parsedAmountWrapped2',currencyA,currencyB);
    ...
    <PageWrapper gap="lg" justify="center">
            ...
            <TYPE.body fontSize={24} fontWeight={500}>
              {valueOfTotalStakedAmountInUSDC
                ? Math.ceil(parseFloat(valueOfTotalStakedAmountInUSDC.toFixed(6))) !== 0
                  ? stakingInfo?.isTokenOnly
                    ? `$${valueOfTotalStakedAmountInUSDC.toFixed(4, { groupSeparator: ',' })}  /  ${valueOfTotalStakedAmountInWETH?.toSignificant(4, { groupSeparator: ',' })}TSU `
                    : `$${valueOfTotalStakedAmountInUSDC.toFixed(4, { groupSeparator: ',' })}  /  ${stakingInfo?.totalStakedAmount?.toSignificant(4)}LP `
      ...
      {showAddLiquidityButton && (
        <VoteCard>
          ...
          <CardSection>
            <AutoColumn gap="md">
              <RowBetween>
                <TYPE.white fontWeight={600}>Step 1. Get {(stakingInfo?.name && stakingInfo?.name !== "" ? stakingInfo.name : "TSU LP")} Liquidity tokens</TYPE.white>
              </RowBetween>
              <RowBetween style={{ marginBottom: '1rem' }}>
                <TYPE.white fontSize={14}>
                  {(stakingInfo?.name && stakingInfo?.name !== "" ? stakingInfo.name : "TSU LP") + " tokens are required. Once you've added liquidity to the " + currencyA?.symbol + "-" + currency2?.symbol + " pool you can stake your liquidity tokens " + (stakingInfo?.lp && stakingInfo?.lp !== "" ? " " : " ")}
      ...
      <PositionInfo gap="lg" justify="center" dim={showAddLiquidityButton}>
                ...
                <RowBetween style={{ alignItems: 'baseline' }}>
                  <TYPE.white fontSize={36} fontWeight={600}>
                    {valueOfMyStakedAmountInUSDC
                      ? stakingInfo?.isTokenOnly
                        ? `$${valueOfMyStakedAmountInUSDC.toFixed(0, { groupSeparator: ',' })}  /  ${valueOfMyStakedAmountInWETH?.toSignificant(4, { groupSeparator: ',' }) ?? '  -  '} TSU`
                        : `$${valueOfMyStakedAmountInUSDC.toFixed(0, { groupSeparator: ',' })}  /  ${stakingInfo?.stakedAmount?.toSignificant(4)} LP`
                  ...
                  <TYPE.white>
                    {
                      stakingInfo?.isNftToken ?
                        ...
                        !stakingInfo?.isTokenOnly ?
                          <>
                            {stakingInfo?.name && stakingInfo?.name && stakingInfo.name !== '' ? stakingInfo.name : 'TSU LP ' + ((currencyA?.symbol !== undefined ? currencyA?.symbol : '') + '-' + (currencyB?.symbol !== undefined ? currencyB?.symbol : ''))}
            ...
            {stakingInfo?.name !== 'vault' ?
              <>
                ...
                <AutoColumn gap="sm">
                  <RowBetween>
                    <div>
                      <TYPE.black>Your unclaimed TSU</TYPE.black>
              ...
              <>
                ...
                <AutoColumn gap="sm">
                  <RowBetween>
                    <div>
                      <TYPE.black>Recent TSU profit</TYPE.black>
                    </div>
                    {stakingInfo?.earnedAmount && JSBI.notEqual(BIG_INT_ZERO, stakingInfo?.earnedAmount?.raw) && (
                      <ButtonEmpty
                        padding="8px"
        ...
        <TYPE.main style={{ textAlign: 'center' }} fontSize={14}>
          ...
          When you withdraw, the contract will automatically claim TSU on your behalf!
        </TYPE.main>
        ...
        {!userLiquidityUnstaked ? null : userLiquidityUnstaked.equalTo('0') ? null : (
          !stakingInfo?.isNftToken ?
            <TYPE.main>{userLiquidityUnstaked.toSignificant(6)} {stakingInfo?.name !== '' ? stakingInfo?.name : 'TSU LP'} tokens available</TYPE.main>
            :
            <></>
        )}
      </PositionInfo>
