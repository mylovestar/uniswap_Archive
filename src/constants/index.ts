...
export const USDC = new Token(ChainId.MAINNET, '0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48', 6, 'USDC', 'USD Coin (PoS)')
...
export const TSU = new Token(ChainId.MAINNET, '0xaa6A6C065116004743f5199Ab457C94D45f2Ab62', 9, 'TSU', 'TSU')
...
export const UNI: { [chainId in ChainId]: Token } = {
  [ChainId.MATIC]: new Token(ChainId.MAINNET, UNI_ADDRESS, 18, 'UNI', 'Uniswap'),
 ...
 // [ChainId.MATIC]: new Token(ChainId.MATIC, '0x35db0dfb42dfe164a3e4d39f91459878d564fa5b', 5, 'SPYRIT', 'SpyritCoin')
  [ChainId.MAINNET]: new Token(ChainId.MAINNET, '0xaa6A6C065116004743f5199Ab457C94D45f2Ab62', 9, 'TSU', 'TSU')
}
...
export const SUGGESTED_BASES: ChainTokenList = {
  ...WETH_ONLY,
  [ChainId.MAINNET]: [TSU,...WETH_ONLY[ChainId.MAINNET],  DAI, USDC, USDT, WBTC]
}
